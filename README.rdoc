...
<small>Meaning: I'm still learning Ruby and the Rails architecture and although I'm very familiar with MVC and other programming languages, coming to Ruby means learning everything again. I will mess up a lot. And that's ok but beware! If you have something to add, *by all means, do so*.</small>
...
It's mainly a fun project which is why I'm putting it free and open source. It's my way to learn and give back some of my knowledge to the community. Also, I'm fat and need to learn to eat again :'(